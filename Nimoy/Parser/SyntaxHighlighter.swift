...
class SyntaxHighlighter {
                ...
                if line.contains("*/") {
                    ...
                    if let startRange = line.range(of: "/*"), let endRange = line.range(of: "*/") {
                        ...
                        if commentStart > 0 {
                            ...
                            highlightExpression(beforeComment, in: attributed, startingAt: currentLocation, font: font, theme: theme)
                        }
                        ...
                        if !afterComment.isEmpty {
                            ...
                            highlightExpression(afterComment, in: attributed, startingAt: afterStart, font: font, theme: theme)
                        }
                    }
                } else {
    ...
    private static func highlightExpression(_ text: String, in attributed: NSMutableAttributedString, startingAt offset: Int, font: NSFont, theme: Theme) {
